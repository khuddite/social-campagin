...
def build_pipeline() -> StateGraph:
    """Construct and compile the 8-node campaign pipeline."""
    ...
    builder.add_node("check_brand", check_brand)
    builder.add_node("check_legal", check_legal)
    ...
    builder.add_edge("composite_assets", "check_brand")
    builder.add_edge("check_brand", "check_legal")
    builder.add_edge("check_legal", "generate_report")
